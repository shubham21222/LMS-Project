            ...
            <div className="pb-32 bg-gradient-to-r from-blue-100 via-purple-100 to-pink-50">
                <div className="max-w-7xl mx-auto px-6 py-4">
                    ...
                    <nav className="flex items-center space-x-2 text-sm">
                        ...
                        <span className="text-black">Find A Tutor</span>
                    </nav>
                </div>
                            ...
                            {tutors.map((tutor, index) => (
                                ...
                                >
                                    <div className="flex items-start gap-4 p-4">
                                        {/* Video Thumbnail */}
                                        <div className="w-36 h-24 bg-black rounded-md flex justify-center items-center text-white">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm text-gray-500">
                                                {tutor.live} Live schedule • {tutor.booked} Booked
                                                schedule • {tutor.reviews} Reviews
                                            </p>
